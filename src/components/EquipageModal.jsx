...
const s = {
  ...
  row: { display: 'flex', alignItems: 'center', gap: 12, padding: '8px 0', borderBottom: '1px solid rgba(255,255,255,0.05)', justifyContent: 'space-between' },  rowInfo:      { flex: 1, minWidth: 0 },
